...
export const metadata = {
  ...
  description:
    "About Phone Repair Center, We provide top-tier phone repair courses & mobile phone repair training. Learn phone screen repair and other essential skills with us today! ",
  keywords: [
    "PRC",
    "tech solutions",
    "data recovery",
