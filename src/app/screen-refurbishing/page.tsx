...
export const metadata = {
  title: "Screen Refurbishing Service - Mobile Screen Repair | PRC Repair",
  description:
    "PRC Repair offers professional screen refurbishing service & mobile screen repair. Restore cracked or damaged screens with expert care. Get your screen fixed today!",
  keywords: [
