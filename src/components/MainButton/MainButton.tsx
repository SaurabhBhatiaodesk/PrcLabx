...
const MainButton: React.FC<MainButtonProps> = ({ MainButton, link, color }) => {
  ...
  // Button styles
  const buttonStyles = `border-[2px] border-[#FFFFFF] text-white text-[13px] 2xl:text-[13px] xl:text-[14px] font-semibold tracking-[2px] uppercase text-black py-3 2xl:py-[10px] xl:py-[10px] px-[15px] rounded-[50px] transition duration-300 ease-in-out transform hover:scale-90 hover:bg-gradient-to-r  hover:bg-${buttonColor} my-2`;
