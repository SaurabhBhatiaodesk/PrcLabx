        ...
        <div className='py-3'>
          <div className='flex py-4 border-[1px] border-[#00303E] rounded-full'>
            <select name="" id="" className='text-black outline-none w-[90%] m-auto'>
              ...
              <option value="item1" className='text-black'>item1</option>
              <option value="item2" className='text-black'>item2</option>
              <option value="item3" className='text-black'>item3</option>
              <option value="item4" className='text-black'>item4</option>
              <option value="item5" className='text-black'>item5</option>
            </select>
          </div>
