...
export const metadata = {
  title: "B2B Mobile Phone Repair Service - Bulk Device Repair | PRC Repair",
  description:
    "PRC Repair offers expert B2B phone repair service and bulk device repair for businesses. Get fast, reliable maintenance & quality repairs for all your devices today!",
